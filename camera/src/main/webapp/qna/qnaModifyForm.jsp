...
<%
	...
	if(loginUsers.getUsersNo() != qna.getQnaUsersNo() && loginUsers.getUsersStatus() != 9) {
		request.setAttribute("returnUrl", request.getContextPath()+"/index.jsp?workgroup=error&work=error_400");
		return;
	}
%>
...
<div class="container mt-5">
    ...
    <form action= "<%= request.getContextPath() %>/index.jsp?workgroup=qna&work=qnaModify" method="post" id="qnaForm">
