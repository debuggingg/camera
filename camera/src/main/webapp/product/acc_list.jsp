    ...
    <main>
        <section class="product-list">
            ...
            <div class="pagination">
                <% if (pageNum > 1) { %>
                    <a href="acc_list.jsp?pageNum=<%= pageNum - 1 %>&filter=<%= filter %>">&laquo;</a>
                <% } %>
                <% for (int i = 1; i <= totalPage; i++) { %>
                    <a href="acc_list.jsp?pageNum=<%= i %>&filter=<%= filter %>" class="<%= (i == pageNum) ? "active" : "" %>"><%= i %></a>
                <% } %>
                <% if (pageNum < totalPage) { %>
                    <a href="acc_list.jsp?pageNum=<%= pageNum + 1 %>&filter=<%= filter %>">&raquo;</a>
                <% } %>
            </div>
            <div class="floating">
